...
**A1:** This read_csv has an internet link rather than a file that can be opened in R.
...
**A2:** There are 9776 records in the dataset. The dataset describes every earthquake around the world, including time, location (in terms of place, longitude, and latitude), and magnitude. 
...
**A3:** The highest depth is 669.9820, and it had a magnitude of 4.20.
...
**A7:** Look at the column "place" and filter out only results that say "Alaska". 3,423 earthquakes took place in Alaska.
...
**A8:** The two most common types are earthquakes (9,540) and quarry blasts (129).
...
**A9:** The average depth of earthquakes is 25.28. I find it interesting that there are negative values and that the average depth for earthquakes is so much different than the other types.
...
**A10:** Use the mutate function and extract the hour from "time", since R already recognizes it as a date.
...
**A11:** Use the mutate function to create a new function and tell R to label anything with a magnitute greater than 3 as "serious" and everything else as "not serious".
...
**A12**: The hour of 2 AM has the most serious earthquakes and the hour of 12 PM has the least serious earthquakes.
