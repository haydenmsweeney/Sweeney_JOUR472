...
A1. July 14th and October 4th had the most overdose calls with 23 on each day. I think there might be days with no overdose calls, but they aren't in the dataset. 
...
A2. There seems to be a minor increase in overdose calls on weekends, which extends into Monday.
...
baltco_911_overdose_calls |>
  ...
  summarise(count = n()) |>
  mutate(pct_total = count/3890*100) |>
...
A3. 4540 Silver Spring Rd has the most calls, with 36. When I looked up this address, I did not find a building associated with it. It makes me question how accurate these locations are - maybe they are just generalized to a certain area.
...
A4. Why are there more calls for overdoses on weekends?
