...
**A1.** "Failing" is the top word, which makes sense because these are sanctions. The top 10 words are a lot of commonly used words in court, so this list is no surprise to me.
...
**A2.** "Attorney trust account" is the top three-word phrase, appearing 343 times. An attorney trust account is a bank account where an attorney keeps client funds safe until they want to withdraw them. In this context, these are instances where the attorney was dishonest - maybe they took money from the account for themself or didn't let their client withdraw.
