...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** The column names are not actual names - "x26", "x59", etc.
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** There still aren't actual names for the columns.
...
**Task** Run the codeblock below. What else do we need to do? **Answer** Remove all the periods. 
