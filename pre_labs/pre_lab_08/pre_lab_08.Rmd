...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer** First we are extracting the month from the date and representing it as the name of the month, rather than a number. Then we are grouping by month, and telling R to find the total number of calls in each month, and putting them in descending order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a blank grey box.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It creates a bar graph showing the total number of calls (y-axis) for each month (x-axis).
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This made the bar chart horizontal instead of vertical.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The background color changed and the text is bigger.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is now a title for the graph in bold leters, the labels for the axes have changed, and a source for the data is given.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The table shows the number of calls for each day in 2022.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a line chart representing the number of calls on each day but it is messy and hard to read.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It has changed the labels to show labels for each week but it is very messy and hard to read.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The graph is still messy and congested, but I can now see individual dates in the labels.
