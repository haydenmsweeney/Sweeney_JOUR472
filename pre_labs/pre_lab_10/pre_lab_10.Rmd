...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** I can see zip codes, city/area names, and the length, area, and geometry of each zip code.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It takes me to the table.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It creates a map of the state of Maryland with boundaries of zip codes.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It installed tigris.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It shows us all of the rows and columns. There are 3,234 rows and 18 columns.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a new table only using counties with a STATEFP of 24. I'm not sure what this variable means though.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a map of the state of Maryland showing all the counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It made a map of the state of Maryland with boundaries for zip codes AND counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is making a new table with foreclosures by zip code only for the month of March 2023.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It joined two data sets by like column, which is zip code.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a map of the state of Maryland showing how many foreclosures there were in each zip code in March 2023.
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer** It loaded all the necessary libraries.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a new table with all of the foreclosures for each county, and changed the character type of some of the variables.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Created a table with the estimated population of each county as well as geometric shape.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It allows us to view both datasets from the last two questions.
...
**Task** Run the following code. Describe the output in the space below. **Answer** We are cleaning the names of the md_county_population dataset so that we can join datasets.
...
**Task** Run the following code. Describe the output in the space below. **Answer** We are joining the population and foreclosure data together by their common variable - county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Adds a variable showing the rate of notices based on population in each county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Creates a map showing the rate of foreclosure notices for each county, and the counties are labeled.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It changed the colors from cold colors to warm colors.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** The rate of foreclosures tends to be higher in the central parts of the state.
