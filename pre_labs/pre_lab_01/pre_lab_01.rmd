...
What does it return? Type your answer below: 4
...
**Answer: 60712 observations or rows and 8 variables or columns**
...
**Answer: The first line is selecting the umd_courses data set. The second line is taking all the terms and grouping the results by them. The third and fourth lines are adding up all the records in each term in the dataset.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: This put the variable count_classes in descending order.**
...
**Answer: It grouped the data by term and put the department variable in alphabetical order.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: Added a column for number of seats and sorted by descending order**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: It calculated the mean and median of the number of seats in each class in each term. I am not sure what the top terms have in common, but it appears that the mean number of seats per class is around the same.**
...
**Answer: Now the data is being sorted by descending number of total seats. It is also being grouped by department rather than term.**
...
1.  What is the average number of classes per department?

2.  What department has the most classes?

3.  What department has the least amount of classes?
