...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer** Yes, each table has year, county, and every political party.
...
**Task** Combine the four files into a single data frame using the bind_rows function. Add a description of what this code does to your reference notebook. -- In the new table, there is another "total" column and every row says N/A. 
...
**Task** Run the following code to filter on Frederick County's registration data and look at the results. What stands out to you about the changes in party registration over time? **Answer** Fromn 2016 to 2022, Frederick County when from majority Republican to majority Democrat.
...
**Task** Load the Maryland demographic data and examine it. What kind of information does it contain? **Answer** It contains population information regarding age and race.
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer** Prince George's County has the highest 18+ black population and highest percentage of democrats.
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** Howard County has the highest percentage of 18+ Asian population. The relation between Asian population and percentage of democrats does not appear to be as strong as the relation between Black population and percentage of democrats.
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **Answer** The data type is a number (<dbl>)
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Answer** It is now character.
