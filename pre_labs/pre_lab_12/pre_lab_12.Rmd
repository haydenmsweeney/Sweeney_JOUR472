...
**Task** Run the following code and describe the dataframe it outputs. **Answer** It creates a table of all of Ben Cardin's website's press releases with date, title, and body text.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It shows the text from the press releases in order but eliminates duplicated of words.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It removes punctuation and changes all text to lowercase to ensure we have entirely unique words.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** It shows the most commonly used words in Ben Cardin press releases. It is not interesting because these are very common filler words that don't actually tell us anything.
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** Yes because these words make sense and are unique to Ben Cardin press releases.
...
**Task** Run the following code and describe the results. **Answer** It creates tables that show the top 10 most commonly used words in 2021, 2022, and 2023.
...
**Task** Run the following code and describe the results. **Answer**  It now shows only press releases from 2022 and beyond, ordered from newest to oldest.
...
**Task** Run the following code and describe the results. **Answer** It creates a table showing what two-word phrases were most commonly used in press releases in 2022, represented as a count and a percentage. "Project location" was by far the most common.
...
**Task** Run the following code and describe the results. **Answer** It creates the same table as the previous block of code, but for 2023. "Human rights" and "equal rights" are the most commonly used two-word phrases in 2023, showing that these are important issues this year.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** I don't think any of the sentiments seem incorrect but some of them are ambigious and are listed as "positive" or "negative" when they could be either depending on the context.
