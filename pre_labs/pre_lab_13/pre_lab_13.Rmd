...
**Task** Run the following code and describe the dataframe it outputs. **Answer** It creates a table showing data for each state: education spending, GDP growth, percentage change in population, and who they voted for in the 2020 presidential election.
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer** There seems to be a slight correlation: as percentaage population change increases, GDP growth tends to increase as well.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer** The line of best fit draws a very slight downward line but it is very difficult to see a correlation here.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer** The table shows a very slight negative relationship between GDP growth and education spending, and a more significant (but still not very strong) positive relationship between GDP growth and population change.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** It creates a text box that shows correlation, p-value, and provides a hypothesis and a confidence interval.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** It shows the r-value from earlier of -.06, which is the relationship between GDP growth and education spending.
...
**Task** Run the following code. Describe the table. What do you see? **Answer** It creates a table showing the mean GDP growth, education spending, and population growth for states that voted for Biden and states that voted for Trump.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** It shows the means calculated in the previous task and also provides a t-value and a p-value.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** When we run the t-test with education spending instead, we get a t-value of 4.2 and a p-value much closer to 0, which shows that this data is statistically significant.
